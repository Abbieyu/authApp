...
// /login
router.post('/login',passport.authenticate('local'),cors.corsWithOptions,(req,res)=>{//when the authentical('local') successfully authenticates the user, this will load the user
